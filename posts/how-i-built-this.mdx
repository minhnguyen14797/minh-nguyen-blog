...
This blog uses <a href='https://nextjs.org/' target="_blank">NextJS</a> by <a href='https://twitter.com/vercel?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor' target="_blank">Vercel</a>. 
In short, NextJS is a <a href='https://reactjs.org/' target="_blank">ReactJS</a>
...
- <a href="https://nextjs.org/docs/api-reference/data-fetching/get-static-props" target="_blank">getStaticProps</a>
- <a href="https://nextjs.org/docs/api-reference/data-fetching/get-static-paths" target="_blank">getStaticPaths</a>
